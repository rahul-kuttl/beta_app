...
secureVaultRouter.use(authenticateUser);
...
secureVaultRouter.post(
  "/secure-vault/v1/users/setting/privacy",
  async (req: Request<VaultParams>, res: Response) => {
    try {
...
secureVaultRouter.get(
  "/secure-vault/v1/users/activity-log",
  async (req: Request<VaultParams>, res: Response) => {
    try {
